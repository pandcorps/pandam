...
public class ShootGame extends Guy2Game {
	...
	private final static void loadWeapons() {
		...
		final Panframe flashSmall1Frm = engine.createFrame("frm.flash.small.1", flashSmall1Img, 5); // 2
		final Panframe flashSmall2Frm = engine.createFrame("frm.flash.small.2", flashSmall2Img, 5);
